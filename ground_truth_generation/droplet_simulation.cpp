...
void DropletSimulator::setup() {
    ...
    // Open output files
    // Output files
    this->location_data_file = "../data/loc_data_L" + std::to_string(this->larger_droplet) + "_A" + std::to_string(this->attraction_points) + "_R" + std::to_string(this->repulsion_points) + "_D" + std::to_string(this->disappearing_droplets) + "_M" + std::to_string(this->random_movement)+ "_" + std::to_string(this->num_droplets) + "_" + std::to_string(int(this->droplet_radius)) + ".csv";
    this->meta_data_file = "../data/meta_data_L" + std::to_string(this->larger_droplet) + "_A" + std::to_string(this->attraction_points) + "_R" + std::to_string(this->repulsion_points) + "_D" + std::to_string(this->disappearing_droplets) + "_M" + std::to_string(this->random_movement)+ "_" + std::to_string(this->num_droplets) + "_" + std::to_string(int(this->droplet_radius)) + ".csv";
...
int main() {
    ...
    */
    // Set parameters
    // Length of simulation
    droplet_simulator->number_of_frames = 50;
    droplet_simulator->number_of_recordings = 50;

    // Droplet parameters
    droplet_simulator->num_droplets = 1500;
    droplet_simulator->droplet_radius = 5.8;
    ...
    droplet_simulator->max_intrinsic_velocity = 0.0;
    ...
    // Attraction point (positive focal point) parameters
    droplet_simulator->attraction_points = false;
    droplet_simulator->attraction_movement = false;
    droplet_simulator->num_attractions = 4;
    droplet_simulator->attraction_radius = 100;
    droplet_simulator->attraction_strength = 0.2;
    droplet_simulator->attraction_strength_droplets = 0.03;
    droplet_simulator->attraction_speed = 1;

    // repulsion point (negative focal point) parameters
    droplet_simulator->repulsion_points = true;
    droplet_simulator->repulsion_movement = true;
    droplet_simulator->num_repulsions = 20;
    droplet_simulator->repulsion_radius = 50;
    droplet_simulator->repulsion_strength = 0.02;
    ...
    droplet_simulator->larger_droplet_speed_x = 0.3;
    droplet_simulator->larger_droplet_speed_y = 0.1;
    droplet_simulator->larger_droplet_start_x = droplet_simulator->screen_width / 5.;
    droplet_simulator->larger_droplet_start_y = droplet_simulator->screen_height / 3.;
    ...
    SIMULATION 2
    */
    // // Run with different set of params
    // // Set up data generator
    // droplet_simulator = new DropletSimulator();

    // // Length of simulation
    // droplet_simulator->number_of_frames = 1000;
    // droplet_simulator->number_of_recordings = 20;

    // // Droplet parameters
    // droplet_simulator->num_droplets = 5000;
    // droplet_simulator->droplet_radius = 3.2;
    // droplet_simulator->random_movement = true;
    // droplet_simulator->intrinsic_movement = true;
    // droplet_simulator->max_random_velocity = 0.1;
    // droplet_simulator->max_intrinsic_velocity = 0.1;
    // droplet_simulator->disappearing_droplets = true;
    // droplet_simulator->disappear_probability = 0.0001;
    ...
    // droplet_simulator->attraction_radius = 80;
    // droplet_simulator->attraction_strength = 0.2;
    // droplet_simulator->attraction_strength_droplets = 0.03;
    ...
    // // repulsion point (negative focal point) parameters
    // droplet_simulator->repulsion_points = true;
    // droplet_simulator->repulsion_movement = false;
    // droplet_simulator->num_repulsions = 5;
    // droplet_simulator->repulsion_radius = 80;
    // droplet_simulator->repulsion_strength = 0.2;
    // droplet_simulator->repulsion_strength_droplets = 0.03;
    // droplet_simulator->repulsion_speed = 0.5;

    // // Giant droplet parameters
    // droplet_simulator->larger_droplet = false;
    // droplet_simulator->larger_droplet_radius = 80;
    // droplet_simulator->larger_droplet_speed_x = 0.3;
    // droplet_simulator->larger_droplet_speed_y = 0.01;
    // droplet_simulator->larger_droplet_start_x = droplet_simulator->screen_width / 5.;
    // droplet_simulator->larger_droplet_start_y = droplet_simulator->screen_height / 2.;

    // // Output files
    // droplet_simulator->location_data_file = "../data/loc_data_L" + std::to_string(droplet_simulator->larger_droplet) + "_A" + std::to_string(droplet_simulator->attraction_points) + "_R" + std::to_string(droplet_simulator->repulsion_points) + "_D" + std::to_string(droplet_simulator->disappearing_droplets) + "_M" + std::to_string(droplet_simulator->random_movement)+ "_" + std::to_string(droplet_simulator->num_droplets) + "_" + std::to_string(int(droplet_simulator->droplet_radius)) + ".csv";
    // droplet_simulator->meta_data_file = "../data/meta_data_L" + std::to_string(droplet_simulator->larger_droplet) + "_A" + std::to_string(droplet_simulator->attraction_points) + "_R" + std::to_string(droplet_simulator->repulsion_points) + "_D" + std::to_string(droplet_simulator->disappearing_droplets) + "_M" + std::to_string(droplet_simulator->random_movement)+ "_" + std::to_string(droplet_simulator->num_droplets) + "_" + std::to_string(int(droplet_simulator->droplet_radius)) + ".csv";
    ...
    // // Droplet parameters
    // droplet_simulator->num_droplets = 10000;
    // droplet_simulator->droplet_radius = 2.25;
    // droplet_simulator->random_movement = true;
    // droplet_simulator->intrinsic_movement = true;
    // droplet_simulator->max_random_velocity = 0.05;
    // droplet_simulator->max_intrinsic_velocity = 0.01;
    // droplet_simulator->disappearing_droplets = true;
    // droplet_simulator->disappear_probability = 0.0001;
    ...
    // // repulsion point (negative focal point) parameters
    // droplet_simulator->repulsion_points = false;
    // droplet_simulator->repulsion_movement = false;
    // droplet_simulator->num_repulsions = 5;
    // droplet_simulator->repulsion_radius = 80;
    // droplet_simulator->repulsion_strength = 0.2;
    ...
    // droplet_simulator->larger_droplet_radius = 120;
    // droplet_simulator->larger_droplet_speed_x = 0.3;
    // droplet_simulator->larger_droplet_speed_y = 0.01;
    // droplet_simulator->larger_droplet_start_x = droplet_simulator->screen_width / 5.;
    // droplet_simulator->larger_droplet_start_y = droplet_simulator->screen_height / 2.;
