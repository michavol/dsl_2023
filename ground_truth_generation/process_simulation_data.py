...
if __name__ == '__main__':
    ...
    # simulation_plotter1.save_plots('data')
    # simulation_plotter2.save_plots('data')
    # simulation_plotter3.save_plots('data')
    # simulation_plotter4.save_plots('data')
    # simulation_plotter5.save_plots('data')
    # simulation_plotter6.save_plots('data')
    simulation_plotter2.save_ot_data('ot_data')